...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "shubhayyadav84@gmail.com",
    href: "mailto:shubhayyadav84@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91-8355006651",
    href: "tel:+918355006651",
  },
  {
    icon: Github,
    label: "GitHub",
    value: "github.com/shubhayyadav84",
    href: "https://github.com/shubhayyadav84",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "linkedin.com/in/shubhay-yadav-b66519309",
    href: "https://www.linkedin.com/in/shubhay-yadav-b66519309",
  },
  {
    icon: Instagram,
    label: "Instagram",
    value: "@shubhay.71",
    href: "https://www.instagram.com/shubhay.71",
  },
];
...
I appreciate you taking the time to connect. I'll review your message and get back to you as soon as possible.
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {submitStatus.type && (
                ...
                >
                  ...
                  <p className="text-sm whitespace-pre-line">{submitStatus.message}</p>
                </div>
              )}
            </form>
          </div>
